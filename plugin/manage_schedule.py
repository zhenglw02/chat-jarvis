...
class ManageSchedulePlugin(AbstractPlugin):
    ...
    def get_description(self):
        return "管理我的日程安排的接口，当我询问我的日程安排时，你应该调用本接口。\n" \
               "当我让你增加或删除我的某个日程安排时，你也应该调用本接口。\n" \
               "注意：当你认为需要调用本接口时，你应该先调用【获取当前时间接口】，得到当前的时间后，再结合当前时间和我的日程时间，计算出调用本接口的正确的参数值，再调用本接口。\n" \
               "注意：你不能在不知道当前时间的情况下调用本接口。"
            ...
            "properties": {
                ...
                "create_info": {
                    ...
                    "properties": {
                        "start_time": {
                            "type": "string",
                            "description": "日程开始时间，你应该传入尽可能准确的时间，你应该使用准确的年、月、日、时、分的数值，不能使用如“今天”、“明天”等代词。正确的示例：2023-07-12 00:00:00。\n"
                                           "如果我说了“明天”等相对的时间点，你应该【先调用查询当前时间接口】获取今天的日期，然后计算我说的相对的时间点具体是哪个日期，然后把具体的日期传给我。\n"
                        },
                        "end_time": {
                            "type": "string",
                            "description": "日程结束时间，你应该传入尽可能准确的时间，你应该使用准确的年、月、日、时、分的数值，不能使用如“今天”、“明天”等代词。正确的示例：2023-07-12 00:00:00。\n"
                                           "end_time和duration这两个参数至少要传一个。"
                        },
                        "duration": {
                            "type": "string",
                ...
                "list_info": {
                    ...
                    "properties": {
                        "filter_start_time": {
                            "type": "string",
                            "description": "筛选条件：日程开始时间晚于传入的时间的日程才会返回。传入的值应该是时间格式，例如：2023-07-12 00:00:00"
                        },
                        "filter_end_time": {
                            "type": "string",
                            "description": "筛选条件：日程开始时间早于传入的时间的日程才会返回。传入的值应该是时间格式，例如：2023-07-12 00:00:00"
                        },
                    },
                    "required": [],
                },
